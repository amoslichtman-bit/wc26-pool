    ...
    <main className="min-h-screen p-4 sm:p-8 bg-slate-950 text-slate-200 font-sans pb-32">
      <div className="max-w-[1400px] mx-auto">
        <header className="mb-8 text-center">
          <h1 className="text-4xl font-black text-white mb-2">Phase 1: Group Stage</h1>
          <p className="text-slate-400">Rank the teams based on the final expected standings.</p>
        </header>
